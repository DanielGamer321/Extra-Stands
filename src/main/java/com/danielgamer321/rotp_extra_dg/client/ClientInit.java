...
import com.danielgamer321.rotp_extra_dg.client.render.entity.layerrenderer.*;
...
@EventBusSubscriber(modid = RotpExtraAddon.MOD_ID, bus = EventBusSubscriber.Bus.MOD, value = Dist.CLIENT)
