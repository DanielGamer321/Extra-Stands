...
public class StringDecompositionLayer<T extends LivingEntity, M extends EntityModel<T>> extends LayerRenderer<T, M> {
    ...
    private static final Map<TextureSize, ResourceLocation[]> LAYER_TEXTURES = Util.make(new EnumMap<>(TextureSize.class), map -> {
        map.put(TextureSize._64x32, new ResourceLocation[] {
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/1.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/2.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/3.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/4.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/5.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/6.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/7.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x32/8.png")
        });
        map.put(TextureSize._64x64, new ResourceLocation[] {
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/1.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/2.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/3.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/4.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/5.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/6.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/7.png"),
                new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/biped/layer/string_decomposition/t64x64/8.png")
        });
    });
