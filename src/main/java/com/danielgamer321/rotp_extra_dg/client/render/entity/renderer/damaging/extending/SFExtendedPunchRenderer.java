...
public class SFExtendedPunchRenderer extends ExtendingEntityRenderer<SFExtendedPunchEntity, SFExtendedPunchModel> {
    private static final ResourceLocation STRINGS = new ResourceLocation(RotpExtraAddon.MOD_ID, "textures/entity/projectiles/sf_strings.png");
    private static ResourceLocation SKIN = STRINGS;

    public SFExtendedPunchRenderer(EntityRendererManager renderManager) {
        super(renderManager, new SFExtendedPunchModel(), SKIN);
    }
