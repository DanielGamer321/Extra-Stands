...
public class CommonConfigPacket {
    private final RotpExtraConfig.Common.SyncedValues values;
    
    public CommonConfigPacket(RotpExtraConfig.Common.SyncedValues values) {
        this.values = values;
    }
    ...
    public static class Handler implements IModPacketHandler<CommonConfigPacket> {
        ...
        public CommonConfigPacket decode(PacketBuffer buf) {
            return new CommonConfigPacket(new RotpExtraConfig.Common.SyncedValues(buf));
        }
